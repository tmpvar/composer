  ...
  var Collidable = Composer.Collidable = function(obj) {
    ...
    self.overlaps = {
      ...
      dirty : function() {
        var i=0, l = overlaps.length;
        for (i; i<l; i++) {
          console.log("overlaps: " + overlaps[i].id);
    ...
    self.overlappedBy = {
      ...
      dirty : function() {
        ...
        var i=0, l = overlappedBy.length;
        for (i; i<l; i++) {
          console.log("overlappedBy: " + overlappedBy[i].id);
      ...
      if (node) {
        ...
        for (i; i<l; i++) {
            ...
            )
          {
            stack[i].dirty = true;
            if (stack[i] !== node) {
              stack[i].collides.overlappedBy.dirty();
            }
          }
        }
